    ...
    <header className="relative z-30 shrink-0 h-14 sm:h-16 lg:h-20 bg-white dark:bg-slate-900 border-b border-slate-200/90 dark:border-slate-800 px-3 sm:px-8 flex items-center justify-between transition-colors duration-200 shadow-xs">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="relative flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-primary text-white hover:bg-blue-700 transition-all duration-200 shadow-md overflow-hidden shrink-0"
          title="Notifications"
        >
          ...
          {unreadCount > 0 && location.pathname !== '/notifications' && (
            <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 rounded-full bg-red-500 ring-2 ring-white dark:ring-slate-900 text-white text-[10px] font-black flex items-center justify-center leading-none shadow-md">
